...
import com.example.projectfyp.Activities.QuestionActivity4;
import com.example.projectfyp.R;
import com.example.projectfyp.databinding.ItemSetsBinding;

import java.util.ArrayList;

public class SetAdapter4 extends RecyclerView.Adapter<SetAdapter4.ViewHolder> {

    private static final String TAG = "SetAdapter";
    private final Context context;
    private final ArrayList<SetModel> list;

    public SetAdapter4(Context context, ArrayList<SetModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (position < list.size()) {
            ...
            holder.itemView.setOnClickListener(view -> {
                Intent intent = new Intent(context, QuestionActivity4.class);
