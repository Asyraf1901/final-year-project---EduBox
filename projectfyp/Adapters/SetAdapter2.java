...
import com.example.projectfyp.Activities.QuestionActivity2;
import com.example.projectfyp.R;
import com.example.projectfyp.databinding.ItemSetsBinding;

import java.util.ArrayList;

public class SetAdapter2 extends RecyclerView.Adapter<SetAdapter2.ViewHolder> {

    private static final String TAG = "SetAdapter";
    private final Context context;
    private final ArrayList<SetModel> list;

    public SetAdapter2(Context context, ArrayList<SetModel> list) {
